...
public class HelpProcessor implements CommandProcessor{
    ...
    public SendMessage process(Long chatId, String message) {
        return new SendMessage(
                chatId,
                """
                        This bot is a notification aggregator which collects notifications from multiple services in single place. You can now track links under Github and StackOverflow services.
